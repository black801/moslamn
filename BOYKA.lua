...
sudo_users = {SUDO,1264922434,1236115319,835551362,665877797}   
...
local UserName = (data.username_ or "suorselmoslam")
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/suorselmoslam) \n ❃∫ [قناه السورس](t.me/suorselmoslam)')
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'suorselmoslam')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'suorselmoslam')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'suorselmoslam')..') \n ❃∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/suorselmoslam)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/suorselmoslam)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
𝐒𝐎𝐔𝐑𝐂𝐄  𝐄𝐋𝐌𝐎𝐒𝐋𝐀𝐌 ✵
⇒⇒⇒⇒⇒⇒⇒⇒⇒⇒
[❀ 𝐃𝐄𝐕¹ ļ ˹𝐋𝐄𝐆𝐀𝐍𝐃 ✵](t.me/UU_Le)
[❀ 𝐃𝐄𝐕²ļ ˹𝐁𝐋𝐀𝐂𝐊 𝐇𝐎𝐔𝐒𝐄 ✵](t.me/MS_b_h)
[❀ 𝐂𝐇 ļ 𝐄𝐋𝐌𝐎𝐒𝐋𝐀𝐌 ✵](t.me/suorselmoslam) 
 ⇒⇒⇒⇒⇒⇒⇒⇒⇒⇒
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'suorselmoslam')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'suorselmoslam')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
local TextE = "\n≪━━━━━━𝘽𝙆━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس المسلم ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/suorselmoslam) \n"
local NumFile = 0
...
local UserName = (b.username_ or "suorselmoslam")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'suorselmoslam')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'suorselmoslam')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'suorselmoslam')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'المسلم').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'suorselmoslam')..')'
local iduser = result.sender_user_id_
...
*❃م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ
彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/suorselmoslam)➢ 
]]
